...
== Example
    ...
    c = Rubyoverflow::Client.new
		c.users.each_fetch(:min => 100000) do | result_page |       # Query for all result pages of users with reputation higher than 1000
			result_page.users.each { |user| puts user.up_vote_count } # Print up vote count of these users
		end
